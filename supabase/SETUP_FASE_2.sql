-- SETUP FASE 2 — Ejecutar en Supabase SQL Editor
-- Crea perfiles, preferencias regionales, trigger de alta y RLS.
-- No incluye cuentas, ledger ni módulos financieros de fases posteriores.
